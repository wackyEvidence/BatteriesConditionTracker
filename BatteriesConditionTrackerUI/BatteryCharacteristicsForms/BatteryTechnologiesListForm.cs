...
{
    public partial class BatteryTechnologiesListForm : Form, IModelRequester<BatteryTechnology>
    {
        ...
        private void BatteryTechnologiesListForm_Load(object sender, EventArgs e)
        {
